...
public class C05_repiace {
    public static void main(String[] args) {
        Map<String,Integer> mp1= new HashMap<>();
        mp1.put("A",5);
        mp1.put("B",3);
        mp1.put("C",7);
        System.out.println(mp1);mp1.replace("C",10);//7
        ...
        // verdigimiz key'e ait value verdigimiz deger ise yenisi ile degistirir, yoksa ıgnore eder
